...
class Renderer(Window):
    def __init__(self):
        ...
        self.linear_sort = 'yes' # if you want sort linear number press 'yes' but if you don't want you can press anything
        self.target = 50 # if you don't want order you can press anything but do not press numbers from 0 to 100 type int
        #color over all
        ...
        self.color_text_linear_text_in_box = "#000000"
        self.color_text_linear_text_on_box = "#FFFFFF"
        ...
        self.color_text_binary_text_in_box = "#000000"
        self.color_text_binary_text_on_box = "#FFFFFF"
        ...
        for i, value in enumerate(self.list_num):
            ...
            self.labels.append(Label(str(value), font_name='Cascadia Code', font_size=15,x=self.position_list_num[i] + (self.side / 2), y=self.window_y_ratio * 0.65,
                                     color=hex_to_rgb(self.color_text_linear_text_in_box), anchor_x='center', anchor_y='center',batch=self.batch))
        ...
        for i1, value1 in enumerate(self.list_num):
            ...
            self.labels.append(Label(str(value1), font_name='Cascadia Code', font_size=15,x=self.position_list_num[i1] + (self.side / 2), y=self.window_y_ratio * 0.15,
                                     color=hex_to_rgb(self.color_text_binary_text_in_box), anchor_x='center', anchor_y='center',batch=self.batch))
